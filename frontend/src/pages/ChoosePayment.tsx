...
export default function Payment() {
  ...
  const [paymentOption, setPaymentOption] = useState<'deposit' | 'full' | null>('full');
      ...
      <div className="payment-wrapper">
        <div className="payment-content">
          ...
          <div className="terms-section">
            <button className="terms-row" onClick={() => setTermsAccepted(!termsAccepted)}>
            ...
            <button className="terms-row" onClick={() => setPrivacyAccepted(!privacyAccepted)}>
              <div className="terms-checkbox">
                {privacyAccepted && (
                  <svg viewBox="0 0 24 24" width="14" height="14">
                    <path fill="#333" d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z" />
